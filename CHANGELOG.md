...
## [4.2.1](https://github.com/Pilaton/vscode-npm-lens/compare/v4.2.0...v4.2.1) (2026-02-04)


### Bug Fixes

* **deps:** update dependencies to latest versions ([16dfef4](https://github.com/Pilaton/vscode-npm-lens/commit/16dfef4866c9f7c518bdca93607fe02048bef16f))
...
- Add deprecated package warnings with tooltip ([#new](https://github.com/Pilaton/vscode-npm-lens))
- Add footer with GitHub and Marketplace links ([#new](https://github.com/Pilaton/vscode-npm-lens))
- Add multi-package update queue — update multiple packages simultaneously ([#new](https://github.com/Pilaton/vscode-npm-lens))
- Add weekly download statistics with sparkline charts ([#new](https://github.com/Pilaton/vscode-npm-lens))

### Bug Fixes

- Improve error handling for package updates with 30s timeout ([#new](https://github.com/Pilaton/vscode-npm-lens))
- Add Content Security Policy for webview security ([#new](https://github.com/Pilaton/vscode-npm-lens))
